...
**⚠️ Note:** PostgreSQL **OPTIONAL** untuk development. Bisa pakai **SQLite** dulu (lebih mudah). PostgreSQL untuk production.
...
### Step 0: Buat Folder Project & Struktur Dasar
...
Copy isi dari artifact `.gitignore` yang sudah saya buatkan sebelumnya.
